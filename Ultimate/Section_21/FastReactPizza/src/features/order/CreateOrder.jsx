...
function CreateOrder() {
  ...
  return (
    <div>
      ...
      {/* HERE GET WILL NOT WORK IN THE WAY WE ARE IMPLEMENTING  */}
      <Form method="POST">
        <div>
